...
Create poses for bimolecular and trimolecular transition states of organic molecules. Reactive atoms supported are `CHONPS`. Reactions can be of three :
- d
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjAwMjg3MzA3LDU0NzExMjc5OSwtNjcyMT
E4NTYwXX0=
-->