...
Create poses for bimolecular and trimolecular transition states of organic molecules, that is the reactive atoms are in `CHONPS`
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2MTM4OTg1MDgsNTQ3MTEyNzk5LC02Nz
IxMTg1NjBdfQ==
-->