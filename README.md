...
**Generate transition state structures** (semiempirical level) - After poses generation, these can be used to try to directly obtain transition state structures at the semiempirical level chosen. This is not a default behavior, and it is invoked by the `NEB` keyword. If this is present in the keyword sectimethod used cons
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTUwMjEzMTk2LDYwMDI4NzMwNyw1NDcxMT
